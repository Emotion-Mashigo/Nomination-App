    ...
    <main>
      <div className="main__container">
        ...
        <div className="main__cards">
                ...
                <div className="card">
                  <i
                    className="fa fa-users fa-4x text-lightblue"
                    aria-hidden="true"
                  ></i>
                ...
                <div className="card">
                  <i className="fa fa-archive fa-4x text-lightblue"
                  aria-hidden="true"
                  ></i>
                  <div className="card_inner">
                ...
                <div className="card">
                  <i
                    className="fa fa-comment fa-4x text-lightblue"
                    aria-hidden="true"
                  ></i>
                  <div className="card_inner">
                ...
                <div className="card">
                  <i
                    className="fa fa-thumbs-up fa-4x text-lightblue"
                    aria-hidden="true"
                  ></i>
                  <div className="card_inner">
